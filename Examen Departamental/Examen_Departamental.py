...
qtCreatorFile = "ExamenDepa_LEDS.ui"
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.btn_mostrar_datos.setText("Capturar Datos")
        self.btn_leds.setText("Encender Focos")

        self.btn_conectar.clicked.connect(self.accion)
        self.btn_mostrar_datos.clicked.connect(self.toggle_captura)
        self.btn_leds.clicked.connect(self.control_focos)
        self.btm_salir.clicked.connect(self.close)
    ...
    def accion(self):
        ...
        if texto == "CONECTAR":
            ...
            if self.segundoPlano.isActive():
                ...
                self.btn_mostrar_datos.setText("Continuar Captura")
            if self.arduino and self.arduino.isOpen():
                try:
                    self.arduino.close()
                except Exception as e:
    ...
    def toggle_captura(self):
        ...
        if not self.segundoPlano.isActive():
            ...
            self.btn_mostrar_datos.setText("Detener Datos")
        else:
            self.segundoPlano.stop()
            self.btn_mostrar_datos.setText("Continuar Captura")
    ...
    def control_focos(self):
        ...
        try:
            if not self.focos_encendidos:
                ...
                self.btn_leds.setText("Apagar Focos")
